const en = {
    ...
    targetForwardRules: 'Targeted Forwarding',
    ...
    tgAdminIdsDesc: 'Telegram admin IDs, separated by commas',
    senderWhitelistDesc: 'Sender whitelist, for example netflix.com',
    keywordWhitelistDesc: 'Keyword whitelist, matched emails pass',
    keywordBlacklistDesc: 'Keyword blacklist; matched emails send block notice only',
    blockNotice: 'Block notice',
    blockSilent: 'Silent block',
    tgWebhook: 'TG Webhook',
    duplicateEmailRule: 'Target email rules cannot be duplicated',
