const zh = {
    ...
    tgAdminIdsDesc: '管理员 Telegram ID，多个用,分开',
    senderWhitelistDesc: '发件人白名单，例如 netflix.com',
    keywordWhitelistDesc: '关键词白名单，命中直接放行',
    keywordBlacklistDesc: '关键词黑名单，命中则只发拦截提醒',
    blockNotice: '拦截提醒',
    blockSilent: '静默拦截',
    tgWebhook: 'TG Webhook',
    duplicateEmailRule: '指定邮箱规则不能重复',
